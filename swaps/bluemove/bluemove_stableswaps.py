...
async def fetch_bluemove_swap_events_paginated(
    ...
    """
    Asynchronously fetch up to `pages` pages of bluemove SwapEvent objects.
    """
    event_filter = {
        "MoveEventType": "0xb24b6789e088b876afabca733bed2299fbc9e2d6369be4d1acfa17d8145454d9::stable_swap::Stable_Swap_Event<0x5d4b302506645c37ff133b98c4b50a5ae14841659738d6d733d59d0d217a93bf::coin::COIN, 0xc060006111016b8a020ad5b33834984a437aaa7d3c74c18e09a95d48aceab08c::coin::COIN>"
    }
...
def write_events_to_csv_with_enrichment(events, output_csv="bluemove_stableswap_events.csv"):
    """
...
async def main():
    async with aiohttp.ClientSession() as session:
        ...
        events = await fetch_bluemove_swap_events_paginated(
            session,
            pages=DEFAULT_PAGES,
            limit_per_page=DEFAULT_LIMIT_PER_PAGE,
            descending=DEFAULT_DESCENDING
    ...
    start_csv = time.time()
    output_csv = "bluemove_stableswap_events.csv"
